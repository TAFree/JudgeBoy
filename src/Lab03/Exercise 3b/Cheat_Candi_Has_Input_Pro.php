...
class Candi {
    ...
    public function matchOutput($testdata, $stu_output){
        switch($testdata) {
            case 0:
                $this->output[0] = "scissor (0), rock (1), paper (2): The computer is rock. You are scissor. You lose!";
		...
		break;
            case 1:
                $this->output[0] = "scissor (0), rock (1), paper (2): The computer is paper. You are rock. You lose!";
                foreach($this->output as $key => $value) {
                    if (strcmp($stu_output, $value) === 0) {
                        return $value;
                    }
